---
# TODO: set the publish date before shipping
...
[RY3T](https://ry3t.com/en/), an energy hardware company in Wil, Switzerland, is building the first commercial product to run [Mujina](https://mujina.org), the open-source Bitcoin mining firmware the 256 Foundation instigated and funds. It is called the [Nova](https://nova.ry3t.com/en/?cur=usd).
...
The Nova is in development, with pre-orders open for Switzerland and the EU first, and plans to enter the US market. Specifications, availability, and timelines are RY3T's to announce, and [nova.ry3t.com](https://nova.ry3t.com/en/?cur=usd) is the place to watch.
...
**See the Nova →** [nova.ry3t.com](https://nova.ry3t.com/en/?cur=usd)
