          ...
          <div className="flex items-center justify-between h-16">
              ...
              {topNav.map((item) =>
                item.children ? (
                  ...
                  <Link
                    key={item.label}
                    href={item.href}
                    className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-display font-semibold text-sm uppercase transition-colors duration-200 px-4 py-2 rounded-sm hover:bg-[#7C3AED]/10"
                  >
                    {item.label}
                  </Link>
                )
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hidden lg:inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-[#3f3f3f] text-gray-700 dark:text-gray-200 font-mono text-sm rounded-none hover:border-[#7C3AED] hover:text-gray-900 dark:hover:text-white hover:bg-[#7C3AED]/10 transition-all duration-200"
              >
