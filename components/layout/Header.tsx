          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hidden lg:inline-flex items-center gap-2 px-4 py-2 border border-[#1f1f1f] text-gray-400 font-mono text-sm rounded-none hover:border-[#7C3AED]/50 hover:text-white transition-all duration-200"
              >
