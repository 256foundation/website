    ...
    <div className="relative bg-[#242424] border border-[#1f1f1f] rounded-none overflow-hidden">
      <div className="aspect-[16/9] flex items-center justify-center">
        <div className="text-center px-8">
          <div className="w-16 h-16 mx-auto mb-4 border-2 border-[#3b1445]/30 dark:border-[#5c2070]/30 rounded-none flex items-center justify-center">
            <svg className="w-8 h-8 text-[#3b1445]/50 dark:text-[#c084d8]/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          <p className="font-mono text-[#3b1445]/50 dark:text-[#c084d8]/50 text-xs mt-2">
