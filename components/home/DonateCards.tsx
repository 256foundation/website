  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1f1f1f]">
        {/* Panel A -- Money */}
        <div className="bg-[#111111] p-8 lg:p-10 group hover:shadow-[0_0_20px_rgba(124,58,237,0.15)] transition-all duration-300 relative overflow-hidden">
          ...
          <h3 className="font-display font-bold text-white text-xl mb-3 uppercase">
            Fund the Mission
          </h3>
