    ...
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-16 pt-36">
        ...
        <div className="flex items-center gap-3 mb-12">
          ...
          <span className="font-mono text-gray-700 text-xs">&mdash;</span>
        ...
        <div className="mb-8">
          <h1>
            <Logo height={180} inverted className="max-w-[520px]" />
          </h1>
        </div>

        {/* Tagline */}
        <p className="font-display font-extrabold text-white text-4xl sm:text-5xl lg:text-6xl xl:text-7xl uppercase leading-none max-w-3xl mb-6">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-16">
          <Link
            href="/mission"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#0a0a0a] font-mono font-bold text-sm rounded-none hover:bg-gray-100 transition-colors duration-200"
          >
            Our Mission
        ...
        <div className="border-t border-[#1f1f1f] pt-6 grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[
            ...
            <div key={label} className="group">
              ...
              <div className="font-mono text-gray-600 text-xs uppercase tracking-widest mt-0.5">
                {label}
              </div>
            </div>
          ))}
