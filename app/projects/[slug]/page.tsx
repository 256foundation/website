            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <ExternalLink
                  ...
                  className="inline-flex items-center gap-2 border border-gray-200 dark:border-[#1f1f1f] text-gray-600 dark:text-gray-300 font-mono px-5 py-2.5 rounded-none hover:border-[#7C3AED]/40 hover:text-[#7C3AED] transition-colors"
                >
                  Forum
                </ExternalLink>
              </div>
